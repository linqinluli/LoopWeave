...
def connect(cfg: Config) -> tinker.ServiceClient:
    ...
    # Alternative: use loopweave.get_service_client() for auto-discovery/embedded mode
    # import loopweave; return loopweave.get_service_client()
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="LoopWeave-Chat SFT training")
