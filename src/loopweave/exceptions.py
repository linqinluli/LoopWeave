...
@dataclass
class LoopWeaveException(Exception):
    """Base exception for LoopWeave errors."""
...
class ServerException(LoopWeaveException):
...
class ModelException(LoopWeaveException):
    """Base exception for Model related errors."""


class CheckpointException(LoopWeaveException):
...
class FutureException(LoopWeaveException):
    """Base exception for Future related errors."""


class SessionException(LoopWeaveException):
    """Base exception for Session related errors."""


class AuthenticationException(LoopWeaveException):
    """Base exception for Authentication related errors."""


class LossFunctionException(LoopWeaveException):
    """Base exception for Loss Function related errors."""


class InvalidRequestException(LoopWeaveException):
...
class ServiceUnavailableException(LoopWeaveException):
...
class PersistenceException(LoopWeaveException):
...
class ConfigMismatchError(PersistenceException):
    ...
    def __init__(
        ...
        message = (
            ...
            "  2. Run `loopweave clear persistence -c <config_path>` to clear existing data\n"
