...
# loopweave_user_console.sh - Launch the LoopWeave user console
...
Launch the LoopWeave user console (including backend server and frontend GUI).

Options:
    --server-url URL     URL of the LoopWeave server (required)
...
if [[ -z "$LOOPWEAVE_SERVER_URL" ]]; then
...
echo "Configuration:"
echo "  LoopWeave Server URL: $LOOPWEAVE_SERVER_URL"
...
export LOOPWEAVE_SERVER_URL="$LOOPWEAVE_SERVER_URL"
export LOOPWEAVE_GUI_URL="http://localhost:$GUI_PORT"
