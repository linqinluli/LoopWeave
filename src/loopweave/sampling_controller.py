...
_get_tracer = lambda: get_tracer("loopweave.sampling_controller")  # noqa: E731
...
class SamplingController:
    ...
    async def create_sampling_session(
        ...
        *,
        ...
        with _get_tracer().start_as_current_span(
            ...
            span.set_attribute("loopweave.sampling_session_id", sampling_session_id)
            if base_model:
    ...
    async def run_sample(
        ...
        with _get_tracer().start_as_current_span("sampling_controller.run_sample") as span:
            ...
            span.set_attribute("loopweave.num_samples", request.num_samples)
