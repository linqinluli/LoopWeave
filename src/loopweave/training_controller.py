...
_get_tracer = lambda: get_tracer("loopweave.training_controller")  # noqa: E731
...
class TrainingController:
    ...
    async def create_model(
        ...
        with _get_tracer().start_as_current_span("training_controller.create_model") as span:
            span.set_attribute("loopweave.training_run_id", model_id)
            span.set_attribute("loopweave.session_id", session_id)
            span.set_attribute("loopweave.base_model", base_model)
            span.set_attribute("loopweave.lora_rank", lora_config.rank)
            try:
    ...
    async def run_forward(
        ...
        *,
        ...
        with _get_tracer().start_as_current_span(span_name) as span:
            span.set_attribute("loopweave.training_run_id", model_id)
            span.set_attribute("loopweave.session_id", record.session_id)
            span.set_attribute("loopweave.backward", backward)
            span.set_attribute("loopweave.data_count", len(data))
            span.set_attribute("loopweave.loss_fn", loss_fn)
    ...
    async def run_optim_step(
        ...
        with _get_tracer().start_as_current_span("training_controller.run_optim_step") as span:
            span.set_attribute("loopweave.training_run_id", model_id)
            span.set_attribute("loopweave.session_id", record.session_id)
            span.set_attribute("loopweave.learning_rate", params.learning_rate)
    ...
    async def save_checkpoint(
        ...
        with _get_tracer().start_as_current_span("training_controller.save_checkpoint") as span:
            span.set_attribute("loopweave.training_run_id", model_id)
            span.set_attribute("loopweave.session_id", training_run.session_id)
            span.set_attribute("loopweave.checkpoint_type", checkpoint_type)
