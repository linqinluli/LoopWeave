...
from loopweave.exceptions import LossFunctionMissingInputException
from loopweave.telemetry.tracing import get_tracer, inject_context


_get_tracer = lambda: get_tracer("loopweave.training_backend")  # noqa: E731
