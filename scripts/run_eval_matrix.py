...
MODES = {
    ...
    # ── 4-GPU paper evaluation configs ──
    "serial_async_4gpu": "loopweave_config_eval_serial_async_4gpu.yaml",
    "unified_engine_4gpu": "loopweave_config_eval_unified_engine_4gpu.yaml",
    "colocate_2copies_4gpu": "loopweave_config_eval_colocate_2copies_4gpu.yaml",
    "static_disagg_4gpu": "loopweave_config_eval_static_disagg_4gpu.yaml",
    "optimal_4gpu": "loopweave_config_eval_optimal_4gpu.yaml",
