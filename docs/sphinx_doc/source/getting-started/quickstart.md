...
This example demonstrates how to use LoopWeave for training and sampling with the [Tinker SDK](https://pypi.org/project/tinker/).
...
Prepare your training data in the format expected by LoopWeave:

```python
import tinker
from tinker import types

# Connect to the running LoopWeave server
...
# prompt_tokens = tokenizer.encode("Hello from LoopWeave")
