// Custom JavaScript for LoopWeave documentation (Sphinx Awesome Theme)
...
(function() {
  ...
  function setupVersionSwitcher() {
    ...
    if (!headerBrand || headerBrand.querySelector('.loopweave-version-select')) {
      return;
    }
    ...
    wrapper.className = 'loopweave-version-select';
    wrapper.innerHTML = `
      <div class="loopweave-version-select-inner">
        <span class="loopweave-version-icon" aria-hidden="true">
        ...
        <select id="loopweave-version-select" aria-label="Version" title="Version">
  ...
  function setupLanguageSwitch() {
    ...
    if (!target || target.querySelector('.loopweave-lang-switch')) {
      return;
    }

    const button = document.createElement('button');
    button.type = 'button';
    button.className = 'loopweave-lang-switch';
