"""Tests for loopweave.runtime._config_gen module."""
...
from loopweave.runtime._config_gen import (
...
class TestGenerateConfigDict:
    @patch("loopweave.runtime._config_gen._detect_gpu_count", return_value=2)
    @patch("loopweave.runtime._config_gen._detect_gpu_memory_gb", return_value=80.0)
    ...
    @patch("loopweave.runtime._config_gen._detect_gpu_count", return_value=0)
    @patch("loopweave.runtime._config_gen._detect_gpu_memory_gb", return_value=0.0)
...
class TestGenerateConfigFile:
    @patch("loopweave.runtime._config_gen._detect_gpu_count", return_value=1)
    @patch("loopweave.runtime._config_gen._detect_gpu_memory_gb", return_value=24.0)
