...
These tests require:
- A running LoopWeave server with data_parallel_size > 1
...
BASE_URL = os.getenv("LOOPWEAVE_BASE_URL", "http://localhost:10610")
API_KEY = os.getenv("LOOPWEAVE_API_KEY", "tml-loopweave-dev-key")
BASE_MODEL = os.getenv("LOOPWEAVE_BASE_MODEL", "Qwen/Qwen3-4B-Thinking-2507")
MODEL_PATH = os.getenv("LOOPWEAVE_MODEL_PATH", "/data/models/qwen/Qwen3-4B-Thinking-2507")
...
def main():
    print()
    print("LoopWeave Data Parallel Inference + Training Integration Test")
    print("=" * 70)
